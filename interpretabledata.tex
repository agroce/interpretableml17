...
of the seed tests that tends to generate imitative sub-sequences.
...
provenance, annotating each step with an arbitrarily selected
provenance (since all are guaranteed to produce an equally sized
sub-sequence).
...
responsible for the generated test.
